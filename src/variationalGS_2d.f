...
c
      ...
      VVa =         (a**2*r**2 + 4*d**2*(r**2 + r**4) - 
     -    a*((-2 + r**2)*Sqrt(1 + r**2) + 
     -       2*c*r**2*(2 + r**2)) + 
     -    c*(c*r**2*(2 + r**2)**2 - 
     -       Sqrt(1 + r**2)*(4 + 2*r**2 + r**4)) + 
     -    4*d*(-1 + c*r**4*Sqrt(1 + r**2) - 
     -       r**2*(1 + a*Sqrt(1 + r**2) - 2*c*Sqrt(1 + r**2))))
     -   /(1 + r**2)**3            
      
      
       VV = -g*dexp(-r**2)+l**2/(2*r**2)

      EVARN = Psi0*(-1.0*VVa/2.0 + 1.0*VV)*Psi0*r
